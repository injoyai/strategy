...
func Signal(info extend.Info, klines, minKlines extend.Klines) bool {
	if RecentDaysToCheck <= 0 {
		RecentDaysToCheck = 20
	}

	if len(klines) < RecentDaysToCheck {
		return false
	}
